...
export function ProjectContactForm({ formHeading, formSubheading }: Props) {
  ...
  return (
    <section id="contact-form" className="mt-6 w-full rounded-[16px] border border-white/12 bg-black/35 p-6 backdrop-blur-[8px]">
          ...
          {formStep === 1 ? (
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <button
                ...
                className="btn-gloss relative overflow-hidden rounded-[10px] border border-white/20 bg-[linear-gradient(180deg,#406af0_0%,#3157d1_100%)] px-5 py-3 text-sm font-medium text-white transition-transform hover:scale-[1.01] md:col-span-2"
              >
                Continue
              </button>
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <button
                type="submit"
                className="btn-gloss relative overflow-hidden rounded-[10px] border border-white/20 bg-[linear-gradient(180deg,#406af0_0%,#3157d1_100%)] px-5 py-3 text-sm font-medium text-white transition-transform hover:scale-[1.01]"
              >
                Submit inquiry
              </button>
            </div>
