    ...
    >
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-6">
          ...
          <SimpleContactForm sourcePage="cloud-computing" className="max-w-2xl mx-auto" />
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-blue-400 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">Start Your Cloud Migration</h2>
            <p className="text-xl text-gray-300">
              Transform your infrastructure with our expert cloud computing services.
            </p>
          </div>
          <SimpleContactForm sourcePage="cloud-computing-cta" className="max-w-2xl mx-auto" />
        </div>
      </section>
