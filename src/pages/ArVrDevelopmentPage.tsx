...
const ArVrDevelopmentPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Immersive virtual reality applications for training, entertainment, and simulation.",
    },
    {
      icon: Eye,
      title: "AR Solutions",
    ...
    },
    {
      ...
      description:
        "Engaging AR/VR games with realistic physics and interactive environments.",
    },
    {
      icon: Monitor,
      title: "Training Simulations",
      description:
        "Virtual training environments for education, healthcare, and industrial purposes.",
    },
    {
      icon: Smartphone,
      title: "Mobile AR",
      description:
        "Mobile AR applications for iOS and Android with advanced tracking capabilities.",
    },
    {
      icon: Zap,
      title: "Real-time Rendering",
      description:
        "High-performance 3D rendering and optimization for smooth user experiences.",
    },
  ];
  ...
  const process = [
    {
      ...
      description: "Define AR/VR experience goals and user journey",
    },
    {
      step: "02",
      title: "3D Modeling",
      description: "Create 3D assets, environments, and animations",
    },
    {
      step: "03",
      title: "Development",
      description: "Build interactive AR/VR applications",
    },
    {
      step: "04",
      title: "Testing",
      description: "User testing across different devices and platforms",
    },
    {
      step: "05",
      title: "Deployment",
      description: "Launch and ongoing performance optimization",
    },
  ];
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://res.cloudinary.com/dqogq10ag/image/upload/v1754394533/AdobeStock_576514253-2048x1365_hyjhwi.png")',
    ...
    >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Create immersive experiences with cutting-edge augmented and
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Ready to Enter the Metaverse?</h2>
            <p className="text-xl text-gray-300">
              Let's create immersive AR/VR experiences that captivate and engage your audience.
            </p>
          </div>
          <SimpleContactForm sourcePage="ar-vr-development" className="max-w-2xl mx-auto" />
        </div>
      </section>
        ...
        caseStudies={[
          {
            ...
            testimonial:
              "Revolutionary VR training platform for medical education.",
      ...
      <section className="py-20 bg-black/80 border-t border-green-400/40">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-green-400 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
              Immersive Technologies
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Push the boundaries of reality with our AR/VR development
              expertise.
            </p>
          </div>
        ...
        pricingTiers={[
          {
            name: "AR Starter",
            price: "$12,000",
            description: "Mobile AR development",
            features: [
              "iOS/Android AR App",
              "Basic 3D Tracking",
              "Custom Models",
      ...
      <section className="py-20 bg-gradient-to-r from-green-500/20 to-blue-500/20 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-green-400 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
