  ...
  const features = [
    {
      ...
      description:
        "Secure, automated contracts on Ethereum, Solana, and other blockchain networks.",
    },
    {
      icon: Coins,
      title: "DeFi Solutions",
      description:
        "Decentralized finance applications including DEXs, lending protocols, and yield farming.",
    },
    {
      icon: Link,
      title: "NFT Platforms",
      description:
        "Non-fungible token marketplaces and minting platforms with full blockchain integration.",
    },
    {
      icon: Users,
      title: "DAO Development",
      description:
        "Decentralized autonomous organizations with governance tokens and voting mechanisms.",
    },
    {
      icon: Zap,
      title: "Layer 2 Solutions",
      description:
        "Scaling solutions and sidechains for faster, cheaper blockchain transactions.",
    },
    {
      icon: Lock,
      title: "Wallet Integration",
      description:
        "Seamless integration with MetaMask, WalletConnect, and other crypto wallets.",
    },
  ];
  ...
  const process = [
    {
      step: "01",
      title: "Architecture",
      description: "Blockchain network selection and smart contract design",
    },
    {
      step: "02",
      title: "Development",
      description: "Smart contract coding and security implementation",
    },
    {
      step: "03",
      title: "Testing",
      description: "Comprehensive testing on testnets and security audits",
    },
    {
      step: "04",
      title: "Deployment",
      description: "Mainnet deployment and contract verification",
    },
    {
      step: "05",
      title: "Maintenance",
      description: "Ongoing monitoring and upgrade management",
    },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Build the future of decentralized applications with secure,
      ...
      <ServicePortfolioSection
        serviceId="blockchain-development"
        ...
        caseStudies={[
          {
            ...
            industry: "DeFi",
            challenge: "Need secure DeFi platform",
            ...
            testimonial: "Secure and scalable DeFi platform",
            clientName: "Alex Chen",
            clientRole: "CTO, CryptoFinance",
            clientImage:
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Complete blockchain development services for the decentralized
              future.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-8 rounded-2xl bg-gray-800/50 border border-gray-700/50 hover:border-yellow-400/50 transition-all duration-300"
              >
      ...
      <section className="py-20 bg-black/80 border-t border-yellow-400/40">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Secure and efficient blockchain development from concept to
              deployment.
            </p>
          </div>
        ...
        pricingTiers={[
          {
            name: "Smart Contract",
            price: "$20,000",
            description: "Basic blockchain solution",
            features: [
          ...
          },
          {
            name: "DeFi Platform",
            price: "$60,000",
            description: "Complete DeFi solution",
            features: [
