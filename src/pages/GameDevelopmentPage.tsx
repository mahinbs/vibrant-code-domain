  ...
  return (
    ...
    >
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Ready to Create the Next Hit Game?</h2>
            <p className="text-xl text-gray-300">
              Let's bring your game idea to life with cutting-edge technology and creative excellence.
            </p>
          </div>
          <SimpleContactForm sourcePage="game-development" className="max-w-2xl mx-auto" />
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-500/20 to-pink-500/20 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-red-400 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">Start Your Game Development</h2>
            <p className="text-xl text-gray-300">
              Let's bring your game idea to life with cutting-edge technology and creative excellence.
            </p>
          </div>
          <SimpleContactForm sourcePage="game-development-cta" className="max-w-2xl mx-auto" />
        </div>
      </section>
