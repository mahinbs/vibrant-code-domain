...
const DataAnalyticsPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Interactive dashboards and reports that provide actionable business insights.",
    },
    {
      icon: Database,
      title: "Data Warehousing",
      description:
        "Centralized data storage and ETL processes for unified business intelligence.",
    },
    {
      icon: TrendingUp,
      title: "Predictive Analytics",
      description:
        "Machine learning models to forecast trends and predict business outcomes.",
    },
    {
      icon: Eye,
      title: "Data Visualization",
      description:
        "Beautiful, interactive charts and graphs that make complex data understandable.",
    },
    {
      icon: Zap,
      title: "Real-time Analytics",
      description:
        "Live data processing and streaming analytics for immediate business insights.",
    },
    {
      icon: Brain,
      title: "AI-Powered Insights",
      description:
        "Automated pattern recognition and anomaly detection in your data streams.",
    },
  ];
  ...
  const process = [
    {
      ...
      description: "Analyze existing data sources and quality",
    },
    {
      step: "02",
      title: "Architecture",
      description: "Design data pipeline and analytics architecture",
    },
    {
      step: "03",
      title: "Implementation",
      description: "Build ETL processes and analytics models",
    },
    {
      step: "04",
      title: "Visualization",
      description: "Create dashboards and reporting interfaces",
    },
    {
      step: "05",
      title: "Optimization",
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      price: "Custom",
      description:
        "Full-scale data analytics ecosystem for large organizations",
      features: [
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://res.cloudinary.com/dqogq10ag/image/upload/f_auto,q_auto/v1754397318/BizAnalytics_vs_Intelligence-Hero_copy_ku9lq9.tiff")',
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive data analytics and business intelligence tools for
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-8 rounded-2xl bg-gray-800/50 border border-gray-700/50 hover:border-indigo-400/50 transition-all duration-300"
              >
      ...
      <section className="py-20 bg-black/80 border-t border-indigo-400/40">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From data chaos to clear business insights with proven
              methodologies.
            </p>
          </div>
