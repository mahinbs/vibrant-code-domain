...
import {
  ...
  reshabAuditCallCopy,
} from "../data/reshabBusinessAutomationContent";
import type { ProcessStep } from "../data/process";

const ReshabCostOfInaction = lazy(() =>
  import("../components/reshab/ReshabCostOfInaction").then((m) => ({
    default: m.ReshabCostOfInaction,
  })),
);
...
const ReshabProcessMockupSplit = lazy(() =>
  import("../components/reshab/ReshabProcessMockupSplit").then((m) => ({
    default: m.ReshabProcessMockupSplit,
  })),
);
...
/** Reshab's /business-automation landing — score funnel, custom sections, reshab_leads. */
export default function ReshabBusinessAutomation() {
  useHashScroll();
