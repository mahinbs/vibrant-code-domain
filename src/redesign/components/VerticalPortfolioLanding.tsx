...
/** Same dark-purple radial wash used by homepage Services/Process bands. */
...
export function VerticalPortfolioLanding({
  ...
  return (
    <>
      <SiteBackground />
      <Nav />
      <main className="relative z-10 w-full max-w-[1920px] mx-auto flex flex-col items-center pt-[130px] pb-[80px] px-10 max-md:px-5">
        <section className="w-full border border-white/12 rounded-[16px] p-8 max-md:p-6" style={sectionWashStyle}>
        ...
        {featured ? (
          <section className="w-full mt-8 rounded-[16px] border border-white/12 overflow-hidden" style={sectionWashStyle}>
