    ...
    <>
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-[1920px] flex-col items-center px-5 pb-[80px] pt-[120px] md:px-10">
        <section
          ...
          style={{
            background:
              "radial-gradient(108% 100% at 100% 100.6%, var(--color-purple) 12.8%, rgb(8,16,40) 69.1%, rgba(0,0,0,0.85) 100%)",
          }}
        >
        ...
        <section className="mt-6 w-full rounded-[16px] py-10 md:py-12 px-4 md:px-6" style={sectionWashStyle}>
        ...
        <section className="mt-6 w-full rounded-[16px] py-10 md:py-12 px-4 md:px-6" style={sectionWashStyle}>
          <div className="grid gap-4 xl:grid-cols-2">
            <div className="rounded-[16px] border border-white/12 p-6">
