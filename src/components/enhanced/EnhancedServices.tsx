    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className={`group relative rounded-xl sm:rounded-2xl bg-gray-900/80 backdrop-blur-sm border ${colors.border} hover:bg-gray-800/90 transition-all duration-300 overflow-hidden hover-scale`}
                    ...
                    <div className="flex-1 p-8">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4 ml-8">
                          ...
                          <Link
                            to={service.route}
                            className={`px-6 py-3 rounded-xl ${colors.button} border font-medium transition-all duration-300 hover:scale-105`}
                          >
                            Learn More
                          </Link>
                        </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-8 mt-6">
                        ...
                        <div>
                          ...
                          <div className="space-y-4">
                            <button className={`w-full inline-flex items-center justify-center px-6 py-3 rounded-xl ${colors.button} border font-medium transition-all duration-300`}>
                              Book Free Demo
                            </button>
                            <div className="text-center">
                              <span className="px-4 py-2 bg-gray-800/50 border border-gray-600 rounded-lg text-sm text-gray-300">
        ...
        <div className="text-center mt-16 lg:mt-20 animate-fade-in">
          <Link
            to="/services"
            className="inline-flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/25"
          >
