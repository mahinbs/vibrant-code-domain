...
const Contact = () => {
  ...
  const offices = [
    ...
    },
    {
      ...
      country: "China",
      address:
        "The Hong Kong Club Building Level 16, No. 3A Chater Road, Central, Hong Kong",
      phone: "+852 2123 4567",
    ...
    },
    {
      ...
      country: "Thailand",
      address:
        "15-17, 20, 25-27FI, T-One Building, 8 Soi Sukhumvit 40, Khwaeng Phra Khanong, Khlong Toei, Bangkok 10110, Thailand",
      phone: "+66 2 123 4567",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-8 h-8 min-w-8 rounded-lg ${colors.icon} flex items-center justify-center`}
                      >
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              With presence across 5 strategic locations, we're always close to
              our clients, ensuring seamless collaboration and support across
              multiple time zones.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 p-6">
                    <div
                      className={`w-12 h-12 rounded-xl ${colors.icon} border flex items-center justify-center mb-4`}
                    >
        ...
        >
          <div className="bg-gradient-to-r from-gray-900/50 to-black/50 rounded-3xl p-8 border border-gray-700/30">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto leading-relaxed">
              Join 1,500+ satisfied clients who have transformed their
