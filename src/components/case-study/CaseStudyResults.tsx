            ...
            <div className="bg-gray-900/50 rounded-2xl p-8 mb-16 border border-gray-700/30">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {project.features.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 bg-gray-800/30 rounded-lg p-4"
                  >
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center space-x-4">
                {project.clientLogo ? (
                  ...
                  <RxAvatar className="w-14 h-14 rounded-full object-cover text-gray-300" />
                )}
                <div className="text-left">
                  <div className="text-white font-semibold">
                    {project.extendedTestimonial.author}
                  </div>
                  <div className="text-cyan-400 text-sm">
                    {project.extendedTestimonial.position}
                  </div>
                  <div className="text-gray-400 text-sm">
                    {project.extendedTestimonial.company}
                  </div>
                </div>
              </div>
            </div>
